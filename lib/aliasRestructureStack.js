...
module.exports = {
	...
	aliasFinalize(currentTemplate, aliasStackTemplates, currentAliasStackTemplate) {
		...
		return BbPromise.resolve([ JSON.parse(JSON.stringify(currentTemplate).replace(/Delete/g, 'Retain')), JSON.parse(JSON.stringify(aliasStackTemplates).replace(/Delete/g, 'Retain')), JSON.parse(JSON.stringify(currentAliasStackTemplate).replace(/Delete/g, 'Retain')) ]);
	},
